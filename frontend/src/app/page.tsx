...
const plans = [
  {
    ...
    features: ["Up to 50 members", "2 staff accounts", "Attendance tracking", "Payment recording", "Basic dashboard"],
    popular: false,
  },
  {
    name: "Pro",
    ...
    features: ["Up to 500 members", "10 staff accounts", "WhatsApp reminders", "Advanced analytics", "CSV exports", "Equipment management"],
    popular: true,
  },
  {
    name: "Enterprise",
    ...
    features: ["Unlimited members", "Unlimited staff", "Priority support", "Multi-location", "Custom branding", "API access"],
    popular: false,
  },
];
